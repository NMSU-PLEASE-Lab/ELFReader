// JEC: just including this standard GNU header file in this repo so that
// we don't have to wonder if it is available. Code below is copyright 
// according to the copyright below
